...
<figure className="my-8">
  <AgentPipeline mobileView="scroll" />
  <figcaption className="mx-auto mt-3 max-w-3xl text-center font-mono text-xs leading-5 text-muted-foreground">
    The complete AppSec Agent workflow: review decisions become versioned rules and dependency models that the engine reuses on every scan.
  </figcaption>
</figure>
